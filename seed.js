...
async function seedUsers() {
  try {
    ...
    // Get the users we just inserted
    ...
    await Comment.insertMany([
      // POST 1 (3 comments)
      {
        text: "I joined one of your outreach events last term and it was really fulfilling.",
        user: juan._id,
        page: "org1",
        post: "post1"
      },
      {
        text: "Love the mission of this org! Hoping to volunteer soon.",
        user: maria._id,
        page: "org1",
        post: "post1"
      },
      {
        text: "Thanks to everyone who participated in our last project! 💚",
        user: au._id,
        page: "org1",
        post: "post1"
      },
      ...
      // POST 2 (2 comments)
      {
        text: "The workshops organized here are actually really helpful.",
        user: john._id,
        page: "org1",
        post: "post2"
      },
      {
        text: "Glad to see more students getting involved in volunteer work.",
        user: au._id,
        page: "org1",
        post: "post2"
      },
      ...
      // POST 3 (2 comments)
      {
        text: "Looking forward to the next event announcement!",
        user: maria._id,
        page: "org1",
        post: "post3"
      },
      {
        text: "This org has such a great community.",
        user: juan._id,
        page: "org1",
        post: "post3"
      }
